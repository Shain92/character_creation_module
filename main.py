...
def attack(char_name: str, char_class: str) -> str:
    """Расчет нанесенного урона в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Расчет заблокированного урона в зависимости от класса."""
    if char_class == 'warrior':
    ...
    return ('Уроне не был блокирован')


def special(char_name: str, char_class: str) -> str:
    """Расчет значений специального навыка в зависимости от класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Оповещение о выбранном классе, вывод доступных комманд."""
    if char_class == 'warrior':
